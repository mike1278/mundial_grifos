...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    formButton: _Jetstream_Button__WEBPACK_IMPORTED_MODULE_2__.default,
    formInput: _Jetstream_Input__WEBPACK_IMPORTED_MODULE_1__.default,
    formSection: _Jetstream_FormSection__WEBPACK_IMPORTED_MODULE_0__.default
  },
  data: function data() {
    return {
...
var _hoisted_1 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Crear Producto");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_form_section, {
    onSubmitted: _cache[1] || (_cache[1] = function ($event) {
